...
class Sphinx:
    ...
    def pose_riddle(self, include_hint: bool = False) -> tuple[str, str | None]:
        ...
        Args:
			include_hint (bool, optional): Set to True to ask for hint.
				Defaults to False.

        Returns:
			tuple[str, str | None]: The riddle and a hint or an empty string or
				None if no hint was requested.
        """
        hint = (
    ...
    def check_riddle_answer(self, answer: str, return_hint: bool = False) -> str:
        ...
        Args:
			answer (str): The given answer to the riddle.
				return_hint (bool, optional): Controls whether a hint for the riddle
